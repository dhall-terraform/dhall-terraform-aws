...
, aws_efs_file_system_policy = ./aws_efs_file_system_policy.dhall
...
, aws_emr_instance_fleet = ./aws_emr_instance_fleet.dhall
...
, aws_guardduty_filter = ./aws_guardduty_filter.dhall
